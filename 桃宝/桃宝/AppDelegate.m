...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //窗口的视图控制器 需要导航控制器
    SXTTabBarViewController *tabVC = [[SXTTabBarViewController alloc]init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.bonway.__" in the application's documents directory.
